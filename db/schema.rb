...
ActiveRecord::Schema.define(version: 2019_05_21_134436) do
  ...
  create_table "pop_maps", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["location_id"], name: "index_pop_maps_on_location_id"
  end
  ...
  create_table "resellers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["confirmation_token"], name: "index_resellers_on_confirmation_token", unique: true
  ...
  add_foreign_key "accounts", "resellers"
  add_foreign_key "locations", "countries"
  add_foreign_key "pop_maps", "locations"
end
